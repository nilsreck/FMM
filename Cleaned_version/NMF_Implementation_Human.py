...
def NMF(A, k1, repetitions, init = "SVD", fix_U = True, U = None, fix_V = False, V = None):
    ...
    if init == "rand":
        ...
        J = np.load("/media/sergio/sershiosdisk/Human/Node2Vec_Exp/_J_Matrix_Matrix_Gene_GO_Human.npy")
        L = np.load("/media/sergio/sershiosdisk/Human/Node2Vec_Exp/_L_Matrix_Matrix_Gene_GO_Human.npy")
